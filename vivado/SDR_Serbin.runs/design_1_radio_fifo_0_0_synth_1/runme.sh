...
HD_PWD='C:/SoC_Fall2022/lab_7/Lab7_Serbin/vivado/SDR_Serbin.runs/design_1_radio_fifo_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_radio_fifo_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_radio_fifo_0_0.tcl
